...
# from /home/summer/anaconda3/envs/d4rl/lib/python3.8/site-packages/d3rlpy/dataset.cpython-38-x86_64-linux-gnu.so
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import copy as copy # /home/summer/anaconda3/envs/d4rl/lib/python3.8/copy.py
import warnings as warnings # /home/summer/anaconda3/envs/d4rl/lib/python3.8/warnings.py
import numpy as np # /home/summer/.local/lib/python3.8/site-packages/numpy/__init__.py
import h5py as h5py # /home/summer/anaconda3/envs/d4rl/lib/python3.8/site-packages/h5py/__init__.py
...
class Episode(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'd3rlpy.dataset', '__doc__': ' Episode class.\\n\\n    This class is designed to hold data collected in a single episode.\\n\\n    Episode object automatically splits data into list of\\n    :class:`d3rlpy.dataset.Transition` objects.\\n    Also Episode object behaves like a list object for ease of access to\\n    transitions.\\n\\n    .. code-block:: python\\n\\n        # return the number of transitions\\n        len(episode)\\n\\n        # access to the first transition\\n        transitions = episode[0]\\n\\n        # iterate through all transitions\\n        for transition in episode:\\n            pass\\n\\n    Args:\\n        observation_shape (tuple): observation shape.\\n        action_size (int): dimension of action-space.\\n        observations (numpy.ndarray): observations.\\n        actions (numpy.ndarray): actions.\\n        rewards (numpy.ndarray): scalar rewards.\\n        terminal (bool): binary terminal flag. If False, the episode is not\\n            terminated by the environment (e.g. timeout).\\n\\n    ', '__init__': <cyfunction Episode.__init__ at 0x7f5a20000860>, 'observations': <property object at 0x7f5a1fff8d10>, 'actions': <property object at 0x7f5a1fff8d60>, 'rewards': <property object at 0x7f5a1fff8db0>, 'terminal': <property object at 0x7f5a1fff8e00>, 'transitions': <property object at 0x7f5a1fff8e50>, 'build_transitions': <cyfunction Episode.build_transitions at 0x7f5a20000d40>, 'size': <cyfunction Episode.size at 0x7f5a20000e10>, 'get_observation_shape': <cyfunction Episode.get_observation_shape at 0x7f5a20000ee0>, 'get_action_size': <cyfunction Episode.get_action_size at 0x7f5a20001040>, 'compute_return': <cyfunction Episode.compute_return at 0x7f5a20001110>, '__len__': <cyfunction Episode.__len__ at 0x7f5a200011e0>, '__getitem__': <cyfunction Episode.__getitem__ at 0x7f5a200012b0>, '__iter__': <cyfunction Episode.__iter__ at 0x7f5a20001380>, '__dict__': <attribute '__dict__' of 'Episode' objects>, '__weakref__': <attribute '__weakref__' of 'Episode' objects>})"
...
class MDPDataset(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'd3rlpy.dataset', '__doc__': ' Markov-Decision Process Dataset class.\\n\\n    MDPDataset is deisnged for reinforcement learning datasets to use them like\\n    supervised learning datasets.\\n\\n    .. code-block:: python\\n\\n        from d3rlpy.dataset import MDPDataset\\n\\n        # 1000 steps of observations with shape of (100,)\\n        observations = np.random.random((1000, 100))\\n        # 1000 steps of actions with shape of (4,)\\n        actions = np.random.random((1000, 4))\\n        # 1000 steps of rewards\\n        rewards = np.random.random(1000)\\n        # 1000 steps of terminal flags\\n        terminals = np.random.randint(2, size=1000)\\n\\n        dataset = MDPDataset(observations, actions, rewards, terminals)\\n\\n    The MDPDataset object automatically splits the given data into list of\\n    :class:`d3rlpy.dataset.Episode` objects.\\n    Furthermore, the MDPDataset object behaves like a list in order to use with\\n    scikit-learn utilities.\\n\\n    .. code-block:: python\\n\\n        # returns the number of episodes\\n        len(dataset)\\n\\n        # access to the first episode\\n        episode = dataset[0]\\n\\n        # iterate through all episodes\\n        for episode in dataset:\\n            pass\\n\\n    Args:\\n        observations (numpy.ndarray): N-D array. If the\\n            observation is a vector, the shape should be\\n            `(N, dim_observation)`. If the observations is an image, the shape\\n            should be `(N, C, H, W)`.\\n        actions (numpy.ndarray): N-D array. If the actions-space is\\n            continuous, the shape should be `(N, dim_action)`. If the\\n            action-space is discrete, the shape should be `(N,)`.\\n        rewards (numpy.ndarray): array of scalar rewards. The reward function\\n            should be defined as :math:`r_t = r(s_t, a_t)`.\\n        terminals (numpy.ndarray): array of binary terminal flags.\\n        episode_terminals (numpy.ndarray): array of binary episode terminal\\n            flags. The given data will be splitted based on this flag.\\n            This is useful if you want to specify the non-environment\\n            terminations (e.g. timeout). If ``None``, the episode terminations\\n            match the environment terminations.\\n        discrete_action (bool): flag to use the given actions as discrete\\n            action-space actions. If ``None``, the action type is automatically\\n            determined.\\n\\n    ', '__init__': <cyfunction MDPDataset.__init__ at 0x7f5a200346c0>, 'observations': <property object at 0x7f5a2235f540>, 'actions': <property object at 0x7f5a21484180>, 'rewards': <property object at 0x7f5a1fff8b80>, 'terminals': <property object at 0x7f5a1fff8bd0>, 'episode_terminals': <property object at 0x7f5a1fff8c20>, 'episodes': <property object at 0x7f5a1fff8c70>, 'size': <cyfunction MDPDataset.size at 0x7f5a20034d40>, 'get_action_size': <cyfunction MDPDataset.get_action_size at 0x7f5a20034e10>, 'get_observation_shape': <cyfunction MDPDataset.get_observation_shape at 0x7f5a20034ee0>, 'is_action_discrete': <cyfunction MDPDataset.is_action_discrete at 0x7f5a20000040>, 'compute_stats': <cyfunction MDPDataset.compute_stats at 0x7f5a20000110>, 'append': <cyfunction MDPDataset.append at 0x7f5a200001e0>, 'extend': <cyfunction MDPDataset.extend at 0x7f5a200002b0>, 'dump': <cyfunction MDPDataset.dump at 0x7f5a20000380>, 'load': <classmethod object at 0x7f5a20e4dc10>, 'build_episodes': <cyfunction MDPDataset.build_episodes at 0x7f5a20000520>, '__len__': <cyfunction MDPDataset.__len__ at 0x7f5a200005f0>, '__getitem__': <cyfunction MDPDataset.__getitem__ at 0x7f5a200006c0>, '__iter__': <cyfunction MDPDataset.__iter__ at 0x7f5a20000790>, '__dict__': <attribute '__dict__' of 'MDPDataset' objects>, '__weakref__': <attribute '__weakref__' of 'MDPDataset' objects>})"
...
class Transition(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f5a21483060>'
...
class TransitionMiniBatch(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f5a214830c0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f5a2147c3a0>'

__spec__ = None # (!) real value is "ModuleSpec(name='d3rlpy.dataset', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f5a2147c3a0>, origin='/home/summer/anaconda3/envs/d4rl/lib/python3.8/site-packages/d3rlpy/dataset.cpython-38-x86_64-linux-gnu.so')"
