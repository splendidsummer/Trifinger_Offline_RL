...
from ...models.builders import (
    ...
    # create_equivariant_non_squashed_normal_policy,
...
class IQLImpl(DDPGBaseImpl):
    ...
    def _build_actor(self) -> None:
        ...
        # TODO: MODIFY HERE
        self._policy = create_equivariant_non_squashed_normal_policy(
            self._observation_shape,
            self._action_size,
            self._actor_encoder_factory,
            min_logstd=-5.0,
    ...
    def _build_critic(self) -> None:
        ...
        self._value_func = create_equivariant_value_function(
            self._observation_shape, self._value_encoder_factory
        )
